...
const addressData = [
  {
    icon: faLocationDot,
    title: "Localisation",
    description: "Antananarivo / Fianarantsoa, Madagascar",
  },
  {
    icon: faEnvelope,
    title: "Mon Email",
    description: "tinafaniry0802@gmail.com",
  },
  {
    icon: faPhone,
    title: "Appelez-moi",
    description: "034 47 411 33",
  },
];
          ...
          <div>
            <div>
              ...
              <p className="text-[12px] xs:text-[14px] sm:text-lg md:text-lg max-lg:text-center pt-4 font-normal text-soft-dark">
                Je suis disponible pour un stage de fin d'études. N'hésitez
                pas à me contacter si vous avez une opportunité qui pourrait
                me correspondre.
              </p>
            </div>
